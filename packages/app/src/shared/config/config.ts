...
export const DEFAULT_IMAGE_INTERROGATION_SYSTEM_PROMPT = `You are a professional image captioning assistant. Your task is to objectively generate accurate, detailed, and descriptive image captions based on the provided image.
