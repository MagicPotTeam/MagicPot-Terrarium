...
describe('resolveScreenshotTempDir', () => {
  it('uses Desktop/MagicPot-dev-trash/<run-id> during automated test runs', async () => {
    ...
    ).toBe(pathWin32.join('C:/Users/test/Desktop', 'MagicPot-dev-trash', 'run-123', 'screenshot'))
  })
