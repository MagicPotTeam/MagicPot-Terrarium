...
describe('resolveTestArtifactPath', () => {
  it('routes disposable artifacts into desktop .magicpot-trash/MagicPot/<run-id>', () => {
    expect(
      resolveTestArtifactRoot({
    ...
    ).toBe(pathWin32.join('C:/Users/test/Desktop', '.magicpot-trash', 'MagicPot', 'run-123'))
  ...
  it('rejects automated artifact overrides outside the desktop .magicpot-trash root', () => {
    expect(
      resolveTestArtifactRoot({
        desktopPath: 'C:/Users/test/Desktop',
        tempPath: 'C:/Temp',
  ...
  it('sanitizes the automated run id before composing the trash root', () => {
    expect(
      ...
      pathWin32.join('C:/Users/test/Desktop', '.magicpot-trash', 'MagicPot', 'desktop-takeover')
    )
  })

  it('allows automated artifact overrides only inside the desktop .magicpot-trash root', () => {
    expect(
      resolveTestArtifactRoot({
        desktopPath: 'C:/Users/test/Desktop',
        tempPath: 'C:/Temp',
